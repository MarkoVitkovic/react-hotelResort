...
filterRooms = () => {
  let {rooms, type, capacity,minSize,maxSize,breakfast,pets, price} = this.state
 ...
 //transform values
  ...
  //filter by price
  temp = temp.filter(room => room.price <= price);
  //filter by size
...
export function whithRoomC(Component){
  return function ConWrapp(props){
    return <RoomConsumer>
